...
{{--                    <p>Athar K. just purchased the <strong>standard</strong> package</p>--}}
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="dashboard-stat color-1">
                    <div class="dashboard-stat-content"><h4>{{count($profile->package)}}</h4> <span>Posted Packages</span></div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="dashboard-stat color-2">
                    <div class="dashboard-stat-content"><h4>{{$c_orders}}</h4> <span>Sales Made</span></div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="dashboard-stat color-3">
                    <div class="dashboard-stat-content"><h4>{{count($profile->review)}}</h4> <span>Total Reviews</span></div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="dashboard-stat color-4">
                    <div class="dashboard-stat-content"><h4>{{$b_count}}</h4> <span>Times Bookmarked</span></div>
